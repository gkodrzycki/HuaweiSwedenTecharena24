...
from siamese import SiameseDataset, ContrastiveLoss, SiameseNetwork
...
def calcLoc(
    ...
    if len(valid_anchors) > 0:
        ...
        if method == "Siamese":
            ...
            dataset = SiameseDataset(X_scaled, valid_anchors, y_train, device)
            ...
            with torch.no_grad():
                ...
                for x1, x2 in pairs:
                    ...
                    z1, z2, output = model(x1_tensor.to(device), x2_tensor.to(device))
